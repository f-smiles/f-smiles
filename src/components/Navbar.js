...
export default function DesktopNavbar() {
  ...
  return (
    <>
      ...
      <nav
        id="desktop-nav"
        className="w-full h-full bg-stone-900 shadow xl:block hidden"
      >
      ...
      <nav id="mobile-nav">
        <section
          id="mobile-menu"
          className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-gray-800 fixed top-0 z-10"
        >
        ...
        >
          ...
          <section
            id="mobile-menu-open"
            className="w-full h-full z-40 fixed overflow-y-auto z-40 top-0 bg-gray-800 shadow flex-col justify-between xl:hidden transition duration-150 ease-in-out"
          >
