...
export default function OurTeam() {
  ...
  return (
    <main className="relative overflow-hidden min-h-screen">
      <div>
      <header className="top text-white flex justify-center items-center h-screen overflow-hidden" style={{ backgroundImage: 'url(/images/pinkblur.jpg', backgroundSize: 'cover' }}>
  <div className="headline text-center text-8xl uppercase">
    MEET THE TEAM
  </div>
</header>


        <section className="textZoom h-screen">
          <div
            className="section"
          ...
          >
            <div className="font-HelveticaNowPro font-thin tracking-tight tracking-tighter px-6 py-10 mx-auto">
              <div className="xl:flex xl:items-start xl:-mx-4">
                ...
                <div className="z-50 grid grid-cols-2 gap-8 mt-8 place-items-stretch xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2">
                  <div>
                    <figure className="parent">
                      <img
                        className={`${
                          switchDoctor ? "right" : "switch-right"
                        } object-contain aspect-[2/3] transition-all ease-in-out duration-3000`}
                  ...
                  >
                    <button
                      ...
                      onClick={toggleSwitchDoctor}
                    >
                      <ArrowLeftIcon className=" w-5 h-5 text-primary50" />
                    </button>
                    ...
                    <button
                      ...
                      onClick={toggleSwitchDoctor}
                    >
                      <ArrowRightIcon className=" w-5 h-5 text-primary50" />
                    </button>
                  </div>
                </div>
              </div>
        ...
        <footer className="bottom h-screen flex justify-start items-end flex-wrap">
          <h2 className="reverse text-center text-[3.5rem] transform scale-[200] opacity-0 w-full absolute flex justify-center items-center">
