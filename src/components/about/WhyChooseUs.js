  ...
  return (
    <div className=" w-full px-4 py-4 pt-16">
      <div className="relative z-10 px-4 pt-4 pb-2 space-y-4 text-center text-gray-500 rounded-lg ">
        <div>
          <h1 className="relative mt-20 mb-20 text-5xl text-stone-100">
            <span className="justify-start mr-4 text-black -ml-80">
              Experts in
            </span>{" "}
      ...
      <div className="p-2 mx-auto">
            ...
            <div className="snap-y snap-mandatory h-screen overflow-scroll">
              ...
              >
                ...
                >
                  <p style={{ letterSpacing: ".2px" }} className="">
                    <h1 className="block mb-4 text-5xl text-violet-800">
              ...
              >
                ...
                >
                  <div style={{ position: "relative", zIndex: "1" }}>
                    <p>
                      Currently, Dr. Gregg Frey is a certified orthodontist and
                      is preparing cases for recertification. Dr. Daniel Frey is
                      in the final stages of obtaining his initial
                      certification.
                    </p>
                  </div>
                  <div
              ...
              >
                ...
                >
                  <div style={{ position: "relative", zIndex: "1" }}>
                    <p>
                      To complement our use of cutting-edge diagnostic
                      technology, we uphold the highest standards for our
                      records, ensuring accuracy and precision throughout the
                      treatment process.
                    </p>
                  </div>
                  <div
        ...
        <div className="max-w-xl mx-auto text-center"></div>
          ...
          <div className="w-1/2">
            <p className="px-12 py-8 mx-auto mt-20 text-lg text-center text-violet-800 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
              ...
              <span className="py-2" style={{ letterSpacing: ".2px" }}>
                ...
                unparalleled orthondtic care for over four decades.
              </span>
            </p>
          </div>
          <div
        ...
        <div style={{ display: "flex", alignItems: "flex-start" }}>
          ...
          >
            <Fragment>
              ...
              <Accordion open={open === 2}></Accordion>
            </Fragment>
          </div>
        </div>
        <div className="relative flex py-10 bg-white">
          <div className="relative w-1/3 p-8">
            <div className="absolute z-10 px-2 py-2 mt-40 mb-10 ml-20 text-5xl bg-white ">
              Giving Back
            </div>
          </div>

          <div className="flex items-center justify-center w-1/3">
            <div className="demo" style={{ width: "400px", height: "400px" }}>
              <div className="three">
                <img
    ...
    /> */}
          ...
          <div className="w-1/3 p-8 text-xl text-center text-violet-800">
            ...
            or cannot afford it. If you know someone who could benefit from this
          ...
          >
            <tbody>
              ...
              <tr>
                ...
                <td
                  className="rounded-bl-full rounded-br-full mb-2 bg-violet-50"
                  style={{
                    borderBottom: "1px solid #B17CFF",
                  }}
                >
