...
const WhyChooseUs = () => {
  return (
    <div className=" py-4  w-full px-4 pt-16">
      <img
      ...
      <div className="mx-auto w-full max-w-screen-lg rounded-2xl p-2">
        ...
        <div className="rounded-full relative bg-gradient-to-b from-stone-50 to-stone-50 overflow-hidden">
          ...
          <p className="mt-10 text-center px-12 py-8 mx-auto text-md text-amber-600 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
            ...
            active board-certified orthodontic office in the area. we strive to
            treat attain finished results consistent with the American Board of
            Orthodontics (ABO) qualitative standards. Our dedicated doctors
            place great priority on the certification and recertification
            process, ensuring that all diagnostic records adhere to the ABO
            standards. Currently, Dr. Gregg Frey, a certified orthodontist, is
            actively preparing cases for recertification. Dr. Daniel Frey is in
            the final stages of obtaining his initial certification. To
            complement our use of cutting-edge diagnostic technology, we uphold
...
>
  <button>Schedule a Consultation</button>
        ...
        <p className="mt-10">
          ...
          flexible, zero-interest payment options with low down payments. They
            ...
            <tbody>
              <tr>
                ...
                <td
                  ...
                  style={{ borderLeft: "1px solid green", borderRight: "1px solid green", borderBottom: "1px solid green" }}
                >
